...
export function WhatsAppBar() {
  ...
  return (
    <div className="bg-gray-800 text-white py-2 px-4 relative z-50">
      <div className="flex items-center justify-between text-sm">
        {/* Left side - Contact message */}
        <div className="flex items-center gap-3">
          <span className="font-medium">Need instant help? Connect with us:</span>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="hover:bg-gray-700 rounded p-1 transition-colors ml-2"
