      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-4">How to Own Your Website, Not Rent It</h3>
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-4">The 1–2–4–7 Publishing System</h3>
            <p className="text-gray-700 leading-relaxed mb-6">
        ...
        >
          <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
            <h4 className="font-semibold text-gray-900 mb-3">Building Customer Trust</h4>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
            <h4 className="font-semibold text-gray-900 mb-3">SEO for Service Businesses</h4>
            <p className="text-gray-700 text-sm mb-4">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
            <h4 className="font-semibold text-gray-900 mb-3">Analytics That Matter</h4>
            <p className="text-gray-700 text-sm mb-4">
