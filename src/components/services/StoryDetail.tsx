      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          >
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-4">Video & Photography</h3>
          ...
          >
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-4">Social Content Creation</h3>
            <p className="text-gray-600 leading-relaxed mb-4">
          ...
          >
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-4">Blog & Knowledge Base</h3>
            <p className="text-gray-600 leading-relaxed mb-4">
