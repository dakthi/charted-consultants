    ...
    <div className="flex flex-wrap items-center">
      <div className="order-last xl:order-first flex items-start w-full lg:w-1/2 pl-5 pr-5 xl:pl-0 xl:pr-0">
        <div className="max-w-xl">
          <p className="text-lg font-bold leading-snug tracking-tight text-gray-800 dark:text-white lg:text-2xl lg:leading-tight xl:text-4xl xl:leading-tight">
            Systems that support people.
            <br />
            Stories that build trust.
          </p>

          <p className="text-md leading-normal text-gray-500 dark:text-gray-300 lg:text-xl xl:text-xl xl:mt-5 xl:mb-5 xl:pr-0">
          ...
          <p className="mb-2 text-md leading-normal text-gray-500 dark:text-gray-300 lg:text-xl xl:text-xl xl:mt-5 xl:mb-5 pr-5 xl:pr-0">
          ...
          <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
            <Link
              href="/contact"
              className="mt-2 px-8 py-4 text-sm font-medium text-center text-white bg-gray-800 dark:bg-gray-700 hover:bg-gray-900 dark:hover:bg-gray-600 rounded-md transition"
            >
