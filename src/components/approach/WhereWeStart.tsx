              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">What you've built, how you've grown, what challenges you've overcome</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-2 h-2 bg-blue-600 rounded-full mt-3 mr-4 flex-shrink-0"></div>
                  <div>
                    ...
                    <p className="text-gray-600">The expertise and approach that sets you apart from competitors</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-2 h-2 bg-blue-600 rounded-full mt-3 mr-4 flex-shrink-0"></div>
                  <div>
                    ...
                    <p className="text-gray-600">How clients see you, what they value most, why they choose you</p>
                  </div>
                </div>
              </div>
            </motion.div>
                ...
                <div className="space-y-6">
                  <div className="flex">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Understanding your operations, client journey, and current processes</p>
                    </div>
                  </div>
                  <div className="flex">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">How you're positioned in your market and what makes you different</p>
                    </div>
                  </div>
                  <div className="flex">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">What your best clients value most about working with you</p>
                    </div>
                  </div>
                  <div className="flex">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">Where technology and storytelling can have the biggest impact</p>
                    </div>
                  </div>
                </div>
              </div>
