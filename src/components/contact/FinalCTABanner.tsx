      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 text-center">
        ...
        >
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 text-left">
            ...
            <h3 className="text-xl font-semibold text-white mb-4">Start a Conversation</h3>
        ...
        >
          <a
            ...
            className="inline-flex items-center bg-white text-indigo-900 px-8 py-4 rounded-lg hover:bg-gray-100 transition-colors font-semibold text-lg"
          >
          ...
          <a
            ...
            className="inline-flex items-center bg-transparent border-2 border-white text-white px-8 py-4 rounded-lg hover:bg-white/10 transition-colors font-semibold text-lg"
          >
            <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        >
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div>
              <div className="text-2xl font-semibold text-white mb-2">Technology</div>
              <div className="text-indigo-200 text-sm">Built for speed and ownership</div>
            </div>
            <div>
              <div className="text-2xl font-semibold text-white mb-2">Story</div>
              <div className="text-indigo-200 text-sm">Content that builds authority</div>
            </div>
            <div>
              <div className="text-2xl font-semibold text-white mb-2">Momentum</div>
