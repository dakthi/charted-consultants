    ...
    <section className="py-20 bg-white scroll-snap-section">
      <div className="max-w-6xl mx-auto px-6 md:px-12">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="bg-gray-50 rounded-2xl p-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center py-2 border-b border-gray-200">
                  ...
                  <span className="text-gray-600">10:00 AM - 2:00 PM PST</span>
                </div>
              ...
              <div className="mt-8 p-4 bg-blue-50 rounded-lg">
                <h4 className="font-bold text-blue-900 mb-2">Emergency Support</h4>
          ...
          >
            <div className="bg-gray-50 rounded-2xl p-8">
              <h3 className="text-xl font-bold text-gray-900 mb-6">Time Zone Friendly</h3>
              ...
              <div className="mt-8 p-4 bg-indigo-50 rounded-lg">
                <h4 className="font-bold text-indigo-900 mb-2">Current Time</h4>
